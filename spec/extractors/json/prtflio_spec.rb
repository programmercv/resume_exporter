...
describe Extractor::Prtflio do
  context "having a Prtflio json file" do
    let(:doc) { File.open(RSpec.root + "fixtures/prtflio.json") { |f| JSON.parse(f.read, symbolize_names: true) } }
    subject{ Extractor::Prtflio.new(doc) }
