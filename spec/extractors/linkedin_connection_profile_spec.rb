...
describe ResumeExporter do
  context "having a connection LinkedIn profile html" do
    subject{ ResumeExporter.new(RSpec.root + "fixtures/linkedin_connection_profile.html") }
    let(:expected_data){ JSON.parse(File.read(RSpec.root + "fixtures/linkedin_connection_profile_result.json")) }
